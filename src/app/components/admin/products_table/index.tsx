    ...
    <table>
      <thead>
        <tr className="bg-background border-b text-xs text-gray-500 h-12">
          ...
          >
            CATEGORIA{" "}
            {sortCriteria === "category" && (sortOrder === "asc" ? "▲" : "▼")}
          </th>
          ...
          <th className="p-2" onClick={() => handleSort("old_price")}>
            DESC.
            {sortCriteria === "old_price" && (sortOrder === "asc" ? "▲" : "▼")}
          </th>
          <th className="p-2 cursor-pointer" onClick={() => handleSort("sku")}>
            SKU {sortCriteria === "sku" && (sortOrder === "asc" ? "▲" : "▼")}
          </th>
          ...
          >
            STOCK{" "}
            <span>
              {sortCriteria === "stock" && (sortOrder === "asc" ? "▲" : "▼")}
            </span>
          </th>
          <th
            className="p-2 cursor-pointer"
        ...
        <tbody>
          {sortedProducts.map((product) => {
            return (
              ...
              >
                <td className="p-4 font-MontserratSemibold">{product.name}</td>
